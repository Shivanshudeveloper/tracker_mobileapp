...
router.post('/addteacherlist', async (req, res) => {
    ...
    try {
        ...
        if (year.length === 0) {
            ...
            await TeacherYear_Model.findByIdAndUpdate(
                { _id: year[0]._id },
                year[0],
                {
                    useFindAndModify: false,
...
// Device
router.get('/get/devices/:createdBy', getDevices)
router.get('/get/device/:phoneNumber', getDeviceByPhoneNumber)
router.post('/get/devices/admin', getAdminDevices)
router.post('/create/device', createDevice)
router.put('/update/device', updateDevice)
router.delete('/delete/device/:_id', deleteDevice)

// Hotspots
router.get('/get/hotspots/:createdBy', getHotspots)
router.post('/get/hotspots/admin', getAdminHotspots)
router.post('/create/hotspot', createHotspot)
router.put('/update/hotspot', updateHotspot)
router.delete('/delete/hotspot/:_id', deleteHotspot)

// Groups
router.get('/get/groups/:createdBy', getGroups)
router.post('/create/group', createGroup)
router.put('/update/group', updateGroup)
router.delete('/delete/group/:_id', deleteGroup)

// Subscription
router.get('/subscription/config', subConfig)
router.post('/create/customer', createCustomer)
router.post('/create/subscription', createSubscription)
router.get('/invoice/preview', invoicePreview)
router.get('/subscriptions/:customerId', subscriptions)
...
// Location
router.get(
    '/get/location/:createdBy/:phoneNumber/:month',
    getLocationByNumberAndTracker
)
router.get('/get/location/:phoneNumber', getLocationByNumber)
